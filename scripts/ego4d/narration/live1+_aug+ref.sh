...
${launcher} train.py --deepspeed configs/deepspeed/zero2.json \
    --live_version live1+ \
    --train_datasets ego4d_refined_narration_stream_train ego4d_refined_narration_stream_val \
    --num_train_epochs 2 \
    ...
    --augmentation True \
    --output_dir outputs/ego4d_refined_narration_stream_trainval+augmentation/live1+ \
